...
export function useOpWorkEmployerFormSchema(): VbenFormSchema[] {
  return [
        {
      component: 'Input',
      fieldName: Prisma.OpWorkEmployerScalarFieldEnum.id,
      label: $t('resource.OpWorkEmployer.id'),
      rules: 'required',
      disabled: true,
      labelWidth: 200
    },
...
export function useOpWorkEmployerCreateFormSchema(): VbenFormSchema[] {
  return [
        {
      component: 'Input',
      fieldName: Prisma.OpWorkEmployerScalarFieldEnum.profileId,
...
export function useOpWorkEmployerViewFormSchema(): VbenFormSchema[] {
  return [
        {
      component: 'Input',
      fieldName: Prisma.OpWorkEmployerScalarFieldEnum.id,
