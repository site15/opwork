  ...
  gridOptions: {
    ...
    proxyConfig: {
      ajax: {
        ...
        plannedStartDate: dayjs(item.plannedStartDate),
        plannedEndDate: dayjs(item.plannedEndDate),
        implementationDescription: item.implementationDescription,
        actualStartDate: dayjs(item.actualStartDate),
        developmentStart: dayjs(item.developmentStart),
        testingStart: dayjs(item.testingStart),
        launchDescription: item.launchDescription,
        launchDate: dayjs(item.launchDate),
        goLiveDate: dayjs(item.goLiveDate),
        completionDescription: item.completionDescription,
        actualEndDate: dayjs(item.actualEndDate),
        completionDate: dayjs(item.completionDate),
        maintenanceDescription: item.maintenanceDescription,
        maintenanceStart: dayjs(item.maintenanceStart),
        maintenanceEnd: dayjs(item.maintenanceEnd),
