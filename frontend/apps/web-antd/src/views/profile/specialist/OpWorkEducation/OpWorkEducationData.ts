    ...
    },
    {
      ...
      componentProps: {
        ...
        options: [
          {
            value: 'HIGH_SCHOOL',
            label: $t('resource.OpWorkEducationDegree.HIGH_SCHOOL').split(
              ' - ',
            )[0],
          },
          {
            value: 'ASSOCIATE',
            label: $t('resource.OpWorkEducationDegree.ASSOCIATE').split(
              ' - ',
            )[0],
          },
          {
            value: 'BACHELOR',
            label: $t('resource.OpWorkEducationDegree.BACHELOR').split(
              ' - ',
            )[0],
          },
          {
            value: 'MASTER',
            label: $t('resource.OpWorkEducationDegree.MASTER').split(' - ')[0],
          },
          {
            value: 'DOCTORATE',
            label: $t('resource.OpWorkEducationDegree.DOCTORATE').split(
              ' - ',
            )[0],
          },
          {
            value: 'CERTIFICATE',
            label: $t('resource.OpWorkEducationDegree.CERTIFICATE').split(
              ' - ',
            )[0],
          },
          {
            value: 'DIPLOMA',
            label: $t('resource.OpWorkEducationDegree.DIPLOMA').split(' - ')[0],
          },
          {
            value: 'POSTGRADUATE',
            label: $t('resource.OpWorkEducationDegree.POSTGRADUATE').split(
              ' - ',
            )[0],
          },
        ],
    ...
    },
    {
      ...
      componentProps: {
        ...
        options: [
          {
            value: 'A_PLUS',
            label: $t('resource.OpWorkGrade.A_PLUS').split(' - ')[0],
          },
          { value: 'A', label: $t('resource.OpWorkGrade.A').split(' - ')[0] },
          {
            value: 'A_MINUS',
            label: $t('resource.OpWorkGrade.A_MINUS').split(' - ')[0],
          },
          {
            value: 'B_PLUS',
            label: $t('resource.OpWorkGrade.B_PLUS').split(' - ')[0],
          },
          { value: 'B', label: $t('resource.OpWorkGrade.B').split(' - ')[0] },
          {
            value: 'B_MINUS',
            label: $t('resource.OpWorkGrade.B_MINUS').split(' - ')[0],
          },
          {
            value: 'C_PLUS',
            label: $t('resource.OpWorkGrade.C_PLUS').split(' - ')[0],
          },
          { value: 'C', label: $t('resource.OpWorkGrade.C').split(' - ')[0] },
          {
            value: 'C_MINUS',
            label: $t('resource.OpWorkGrade.C_MINUS').split(' - ')[0],
          },
          {
            value: 'D_PLUS',
            label: $t('resource.OpWorkGrade.D_PLUS').split(' - ')[0],
          },
          { value: 'D', label: $t('resource.OpWorkGrade.D').split(' - ')[0] },
          {
            value: 'D_MINUS',
            label: $t('resource.OpWorkGrade.D_MINUS').split(' - ')[0],
          },
          { value: 'F', label: $t('resource.OpWorkGrade.F').split(' - ')[0] },
          {
            value: 'PASS',
            label: $t('resource.OpWorkGrade.PASS').split(' - ')[0],
          },
          {
            value: 'FAIL',
            label: $t('resource.OpWorkGrade.FAIL').split(' - ')[0],
          },
          {
            value: 'INCOMPLETE',
            label: $t('resource.OpWorkGrade.INCOMPLETE').split(' - ')[0],
          },
          {
            value: 'AUDIT',
            label: $t('resource.OpWorkGrade.AUDIT').split(' - ')[0],
          },
        ],
        showSearch: true,
      },
      ...
      cellRender: {
        ...
        props: {
          options: [
            ...
            {
              value: 'MASTER',
              label: $t('resource.OpWorkEducationDegree.MASTER').split(
                ' - ',
              )[0],
            },
            {
            ...
            {
              value: 'DIPLOMA',
              label: $t('resource.OpWorkEducationDegree.DIPLOMA').split(
                ' - ',
              )[0],
            },
            {
