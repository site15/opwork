...
import { useResumeSearchFilterFormSchema } from './ResumeSearchData';

defineOptions({
  name: 'ResumeSearchFilterForm',
});
...
const [Form, formApi] = useVbenForm({
  schema: useResumeSearchFilterFormSchema(),
...
<template>
  <Card>
    ...
    <CardFooter class="flex flex-wrap gap-2">
      <VbenButton type="primary" class="mt-4" @click="handleSearch">
